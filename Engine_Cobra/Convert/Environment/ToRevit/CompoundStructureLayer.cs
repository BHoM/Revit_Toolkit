...
namespace BH.UI.Cobra.Engine
{
    public static partial class Convert
    {
        ...
        internal static CompoundStructureLayer ToRevitCompoundStructureLayer(this BH.oM.Environment.Elements.ConstructionLayer constructionLayer, Document document, PushSettings pushSettings = null)
        {
        ...
        private static MaterialFunctionAssignment GetMaterialFunctionAssignment(BH.oM.Environment.Elements.ConstructionLayer constructionLayer)
        {
