...
namespace BH.UI.Revit.Engine
{
    public static partial class Convert
    {
        ...
        public static List<oM.Physical.Elements.Floor> ToBHoMFloors(this Floor floor, RevitSettings settings = null, Dictionary<string, List<IBHoMObject>> refObjects = null)
        {
