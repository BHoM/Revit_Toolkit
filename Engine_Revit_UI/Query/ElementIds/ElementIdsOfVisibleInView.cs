...
namespace BH.UI.Revit.Engine
{
    public static partial class Query
    {
        ...
        [Description("Get all Elements as ElementId that are visible in a View")]
        [Input("document", "Revit Document where views are collected")]
        [Input("viewId", "ElementId of the Revit view in which the elements are visible")]
        [Input("ids", "Optional, allows the filter to narrow the search from an existing enumerator")]
        [Output("elementIdsOfVisibleInView", "An enumerator for easy iteration of ElementIds collected")]
        public static IEnumerable<ElementId> ElementIdsOfVisibleInView(this Document document, int viewId, IEnumerable<ElementId> ids = null)
        {
            if (document == null)
                return null;
