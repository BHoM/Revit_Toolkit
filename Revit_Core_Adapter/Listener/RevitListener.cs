...
namespace BH.Revit.Adapter.Core
{
    ...
    public class RevitListener : IExternalApplication
    {
        ...
        private void AddAdapterButtons(UIControlledApplication uiControlledApp)
        {
            ...
            m_ActivateButton = panel.AddItem(new PushButtonData("Activate", "Activate", System.Reflection.Assembly.GetExecutingAssembly().Location, typeof(Activate).FullName)) as PushButton;
            ...
            m_UpdatePortsButton = panel.AddItem(new PushButtonData("Update Ports", "Update\nPorts", System.Reflection.Assembly.GetExecutingAssembly().Location, typeof(SetPorts).FullName)) as PushButton;
            ...
            m_DeactivateButton = panel.AddItem(new PushButtonData("Deactivate", "Deactivate", System.Reflection.Assembly.GetExecutingAssembly().Location, typeof(Deactivate).FullName)) as PushButton;
            ...
            PushButton button = panel.AddItem(new PushButtonData("Adapter Wiki", "Adapter Wiki", System.Reflection.Assembly.GetExecutingAssembly().Location, typeof(RevitToolkitWiki).FullName)) as PushButton;
