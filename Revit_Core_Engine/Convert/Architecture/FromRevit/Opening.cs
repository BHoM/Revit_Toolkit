...
namespace BH.Revit.Engine.Core
{
    public static partial class Convert
    {
        ...
        public static oM.Architecture.BuildersWork.Opening OpeningFromRevit(this FamilyInstance instance, RevitSettings settings = null, Dictionary<string, List<IBHoMObject>> refObjects = null)
        {
            ...
            Parameter diameterParam = instance.LookupParameter(settings.MappingSettings, typeof(oM.Architecture.BuildersWork.Opening), "Diameter");
            ...
            if (profile == null)
            {
                Parameter widthParam = instance.LookupParameter(settings.MappingSettings, typeof(oM.Architecture.BuildersWork.Opening), "Width");
                Parameter heightParam = instance.LookupParameter(settings.MappingSettings, typeof(oM.Architecture.BuildersWork.Opening), "Height");
            ...
            Parameter depthParam = instance.LookupParameter(settings.MappingSettings, typeof(oM.Architecture.BuildersWork.Opening), "Depth");
            if (depthParam != null)
            {
                double depth = depthParam.AsDouble().ToSI(diameterParam.Definition.UnitType);
                opening.Depth = depth;
            }
            else
