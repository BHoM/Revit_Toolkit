...
namespace BH.Revit.Engine.Core
{
    public static partial class Convert
    {
        ...
        [Description("Converts a Revit FamilyInstance to BH.oM.Physical.Elements..")]
        [Input("familyInstance", "Revit FamilyInstance to be converted.")]
        [Input("settings", "Revit adapter settings to be used while performing the convert.")]
        [Input("refObjects", "Optional, a collection of objects already processed in the current adapter action, stored to avoid processing the same object more than once.")]
        [Output("padFoundation", "BH.oM.Physical.Elements.Pile resulting from converting the input Revit FamilyInstance.")]
        public static PadFoundation PadFoundationFromRevit(this FamilyInstance familyInstance, RevitSettings settings = null, Dictionary<string, List<IBHoMObject>> refObjects = null)
        {
            ...
            padFoundation = BH.Engine.Physical.Create.PadFoundation((oM.Geometry.PlanarSurface)locationCurve, null, familyInstance.FamilyTypeFullName());
