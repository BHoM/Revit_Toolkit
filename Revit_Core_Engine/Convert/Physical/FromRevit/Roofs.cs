...
namespace BH.Revit.Engine.Core
{
    public static partial class Convert
    {
        ...
        public static List<oM.Physical.Elements.Roof> RoofsFromRevit(this RoofBase roofBase, RevitSettings settings = null, Dictionary<string, List<IBHoMObject>> refObjects = null)
        {
            ...
            string materialGrade = roofBase.MaterialGrade(settings);
            ...
            foreach (KeyValuePair<PlanarSurface, List<oM.Physical.Elements.IOpening>> kvp in dictionary)
            {
                ...
                bHoMRoof.CopyParameters(roofBase, settings.ParameterSettings);
