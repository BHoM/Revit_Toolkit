...
namespace BH.Revit.Engine.Core
{
    public static partial class Convert
    {
        ...
        [Output("parameterFilterElement", "Revit ParameterFilterElement resulting from converting the input BH.oM.Adapters.Revit.Elements.ViewFilter.")]
        public static Element ToRevit(this BH.oM.Adapters.Revit.Elements.ViewFilter filter, Document document, RevitSettings settings = null, Dictionary<Guid, List<int>> refObjects = null)
        {
            return filter.ToRevitParameterFilterElement(document, settings, refObjects);
        }
