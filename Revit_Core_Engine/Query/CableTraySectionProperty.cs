...
namespace BH.Revit.Engine.Core
{
    public static partial class Query
    {
        ...
        public static BH.oM.MEP.SectionProperties.CableTraySectionProperty CableTraySectionProperty(this Autodesk.Revit.DB.Electrical.CableTray revitCableTray, RevitSettings settings = null)
        {
