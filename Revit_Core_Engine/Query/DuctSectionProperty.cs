...
namespace BH.Revit.Engine.Core
{
    public static partial class Query
    {
        ...
        public static BH.oM.MEP.System.SectionProperties.DuctSectionProperty AnalyticalDuctSectionProperty(this Autodesk.Revit.DB.Mechanical.Duct revitDuct, RevitSettings settings = null)
        {
        ...
        [Input("refObjects", "A collection of objects processed in the current adapter action, stored to avoid processing the same object more than once.")]
        [Output("sectionProperty", "BHoM duct section property extracted from a Revit duct.")]
        public static BH.oM.Physical.ConduitProperties.DuctSectionProperty PHysicalDuctSectionProperty(this Autodesk.Revit.DB.Mechanical.Duct revitDuct, RevitSettings settings = null)
        {
            settings = settings.DefaultIfNull();
