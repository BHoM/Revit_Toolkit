                ...
                case Discipline.Architecture:
                    {
                        ...
                        return inserts.Where(x => x is FamilyInstance && (x.Category.Id.Value() == (int)Autodesk.Revit.DB.BuiltInCategory.OST_Windows || x.Category.Id.Value() == (int)Autodesk.Revit.DB.BuiltInCategory.OST_Doors)).Select(x => x.Id).ToList();
                    }
            }
