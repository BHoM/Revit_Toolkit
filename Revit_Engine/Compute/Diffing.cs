...
namespace BH.Engine.Adapters.Revit
{
    public static partial class Compute
    {
        ...
        [Input("propertiesOrParamsToConsider", "Object properties to be considered when comparing two objects for differences. If null or empty, all properties will be considered." +
            "\nYou can specify also Revit parameter names.")]
        [Output("Diff", "Holds the differences between the two sets of objects. Explode it to see all differences.")]
        public static Diff RevitDiffing(IEnumerable<object> pastObjects, IEnumerable<object> followingObjects, string revitIdName = null, IEnumerable<string> propertiesOrParamsToConsider = null)
        {
        ...
        [Output("Diff", "Holds the differences between the two sets of objects. Explode it to see all differences.")]
        public static Diff RevitDiffing(IEnumerable<object> pastObjects, IEnumerable<object> followingObjects, string revitIdName = null, IEnumerable<string> propertiesOrParamsToConsider = null, DiffingConfig diffConfig = null)
        {
        ...
        [Input("diffConfig", "Further Diffing configurations.")]
        [Output("diff", "Holds the differences between the two sets of objects. Explode it to see all differences.")]
        private static Diff Diffing(IEnumerable<object> pastObjects, IEnumerable<object> followingObjects, string revitIdName = null, IEnumerable<string> propertiesOrParamsToConsider = null, DiffingConfig diffConfig = null)
        {
        ...
        private static bool PropertyFullNameFilter_RevitParameter(string propertyFullName, object propertyValue)
        {
            ...
            // Get the parameter name, and modify the input propertyFullName as if the parameter was a declared property of the object.
            string parameterName = revitParameter.Name;
            if (m_parametersToConsider != null && !m_parametersToConsider.Contains(parameterName))
