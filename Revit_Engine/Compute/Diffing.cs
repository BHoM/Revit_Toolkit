...
namespace BH.Engine.Adapters.Revit
{
    public static partial class Compute
    {
        ...
        {
            return BH.Engine.Diffing.Compute.IDiffing(pastObjects, followingObjects, DiffingType.Automatic, new DiffingConfig() { ComparisonConfig = new ComparisonConfig() { PropertiesToConsider = propertiesToConsider.ToList() } });
        }
