...
namespace BH.Engine.Revit
{
    public static partial class Compute
    {
        ...
        {
            if (element != null)
                Reflection.Compute.RecordError(string.Format("Revit element could not be converted because conversion method does not exist. Element Id: {0}, Element Name: {1}", element.Id.IntegerValue, element.Name));
        }
        ...
        {
            if (document != null)
                Reflection.Compute.RecordError(string.Format("Revit document could not be converted because conversion method does not exist. Document title: {0}", document.Title));
        }
        ...
        {
            if (element == null)
                Reflection.Compute.RecordError(string.Format("BHoM object could not be read because Revit element with Id {0} does not exist.", element.Id.IntegerValue));
        }
        ...
        {
            if (document == null)
                Reflection.Compute.RecordError(string.Format("BHoM object could not be read because Revit document with title {0} does not exist.", document.Title));
        }
        ...
        {
            if (bar != null)
                Reflection.Compute.RecordError(string.Format("Nonlinear bars are currently not supported in BHoM, the object is returned with empty geometry. Element Id: {0}", bar.Id.IntegerValue));
        }
