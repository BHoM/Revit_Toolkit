...
namespace BH.Engine.Adapters.Revit
{
    public static partial class Create
    {
        ...
        [Description("Creates an entity defining the relationship between property name of a type (or CustomData key) and sets of their correspondent Revit element parameter names.")]
        ...
        [Description("Creates an entity defining the relationship between property name of a type (or CustomData key) and sets of their correspondent Revit element type parameter names.")]
        [InputFromProperty("propertyName")]
        [InputFromProperty("parameterNames")]
        [Output("parameterLink")]
        ...
        [Description("Creates a collection of entities defining the relationship between property names of a BHoM type (or CustomData keys) and sets of their correspondent Revit parameter names. If parameter name starts with prefix 'Type:', parameter will be sought for in element's type.")]
        [InputFromProperty("Name of the property (or CustomData key) to be linked with Revit parameters.")]
